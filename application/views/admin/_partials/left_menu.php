...
--> 
            ...
            <ul id="menu" class="collapse">
                ...
                <li class="panel ">
                    <a href="<?php echo site_url();?>admin/plan">Manage Plans</a>
                </li>
                <li class="panel ">
                    <a href="<?php echo site_url();?>admin/plantype">Manage Plan Types</a>
                </li>
                
                <li class="panel ">
                  <a href="<?php echo site_url();?>admin/promo">Manage Promo Codes</a>
                </li>

                <li class="panel ">
                  <a href="<?php echo site_url();?>admin/plan/access">Manage Plan Access</a>
                </li>
                <li class="panel ">
                  <a href="<?php echo site_url();?>admin/servermail">Manage Mails</a>
                  <span style="color: #fff; font-weight:bold;" title="Heresmygps contact mail listings">(contact@heresmygps.com)</span>
                </li>
                <?php } else { ?>
                  <li class="panel ">
                   <a href="<?php echo site_url();?>admin/profile/channels">Manage Channels</a>
                </li>
                
                <li class="panel ">
                    <a href="<?php echo site_url();?>admin/profile">Manage Plans</a>
                </li>
                <li class="panel ">
                    <a href="<?php echo site_url();?>admin/profile">Manage Plan Types</a>
                </li>
                <?php } ?>
                <!--
<li class="panel ">
